...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener simpleServentListener, FifoListener fifoListener) {
		...
		commandList.add(new QuitCommand(this, simpleServentListener, fifoListener));
		commandList.add(new JobCommand());
